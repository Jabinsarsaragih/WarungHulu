...
<head>
    ...
    <script src="https://kit.fontawesome.com/c2865d0547.js" crossorigin="anonymous"></script>
...
<body>
    <div class="banner">
        ...
        <div class="text">
            <h1>Buy Anything You Need <span>From Home</span></h1>
            <div class="paragrafIndex">
                <p id='typewriter'>
                </p>
            </div>
            <div class="acount">
                <a href="#" id="login">Login</a>
                <a href="#" id="singing">Singing</a>
            </div>
        </div>
    </div>
